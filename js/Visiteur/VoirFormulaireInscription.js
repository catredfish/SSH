...
//Lorsque l'utilisateur choisi un programme, met à jour le input qui sera envoyé à l'aide du formulaire.
function choisirProgramme(idProgramme, nomProgramme){
  var lol = $("#input-programme");
  $("#input-programme").val(idProgramme.toString());
  $("#bouton-programme").empty();
  $("#bouton-programme").html(nomProgramme);
  validate($("#contact-form"));
}

$(document).ready(function(){
  $('.dropdown-submenu a.test').on("click", function(e){
    $("ul").not($(this).next('ul')).each(function(){
