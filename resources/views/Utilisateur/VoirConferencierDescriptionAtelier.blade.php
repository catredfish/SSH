...
<div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" onclick="retourDescriptionAtelier({{$idAtelier}})">Retour
            </button>
...
<script src="js/Utilisateur/VoirConferencierDescriptionAtelier.js"></script>
<!-- Style -->
