...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="idTitreModal">S'inscrire à une liste d'attente</h4>
                        ...
                        <div class="input-container">
                            <form action="/SupprimerConferencier" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <p>Voulez-vous vraiment vous inscrire à liste d'attente de l'atelier
                                ...
                                <div class="row submit-row">
                                    <button type="button" onclick="inscriptionDesinscriptionListeAttente({{$model->getAtelier()->id}},{{Session::get('idCompte')}})" class="btn btn-block submit-form">Confirmer</button>
                                </div>
                            </form>
                        </div>
                    </div>
