...
class VoirDescriptionConflitViewModel {
    ...
    public function getNumeroAtelierSelectionne(){
        return $this->numeroAtelierSelectionne;
    }

    //Fonction permettant d'assigner des valeurs aux propriétés du modèle
    public function GenererListe($numeroCampus, $numeroUtilisateur, $paramOngletSelectionnee, $paramDateSelectionnee, $idAtelierSelectionne) {
        //Id atelier
        $this->numeroAtelierSelectionne = $idAtelierSelectionne;
